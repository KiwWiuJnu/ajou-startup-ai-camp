...
├── 대본/
│   └── 발표_대본.md         # 해커톤 발표 피칭 스크립트
├── 상세페이지/
│   └── DESIGN.md           # 화면 UI/UX 가이드라인 및 설명
├── 강의노트AI_창업캠프_기획안.md # 창업 아이디어 기획서
├── 개발기록.md               # 디버깅 및 버전 히스토리
├── 여정지도.md               # 사용자 경험 지도 분석
├── 예상_면접_질문_대비.md     # 면접 준비 예상 Q&A 문서
└── 이력서_기술서_초안.md      # 경력기술서 및 이력서 작성 예시
```
